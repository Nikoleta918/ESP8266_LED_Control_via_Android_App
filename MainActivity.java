...
public class MainActivity extends AppCompatActivity {
    ...
    private String esp8266IP = "http://192.168.51.91"; // Replace with your ESP8266's local IP
    private ExecutorService executorService; //thread managment
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Initialize ExecutorService for use of Threads
        ...
        buttonWater.setOnClickListener(v -> {
            Toast.makeText(MainActivity.this, "Water button clicked", Toast.LENGTH_SHORT).show(); //pop up message in the android app
            //send http request to Arduino
            sendRequest("/blue/on");
        });

        buttonFood.setOnClickListener(v -> {
            Toast.makeText(MainActivity.this, "Food button clicked", Toast.LENGTH_SHORT).show();//pop up message in the android app
            //send http request to Arduino
            sendRequest("/red/on");
        });
    }
